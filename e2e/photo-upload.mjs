...
import { BASE_URL, loadEnvLocal, randomPhone, shooter, assertServerUp, trackConsoleErrors, FIXTURE_PHOTO } from './_helpers.mjs';
...
try {
  ...
  await page.locator('input[placeholder="e.g. B-204"]').fill('A-1');
